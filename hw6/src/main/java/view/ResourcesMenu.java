...
public class ResourcesMenu {
    ...
    */
    public void update() {
        ...
        label1.setText("Strat Level: " + myCiv.getStrategy().getStrategyLevel());
        ...
        //resourceBar.getChildren().addAll(label1, label2, label3, label4, label5, label6);
        // resourceBar.getChildren().set(0, label1);
        // resourceBar.getChildren().set(1, label2);
        // resourceBar.getChildren().set(2, label3);
        // resourceBar.getChildren().set(3, label4);
        // resourceBar.getChildren().set(4, label5);
        // resourceBar.getChildren().set(5, label6);
    }
    /**
